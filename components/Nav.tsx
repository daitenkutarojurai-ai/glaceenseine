...
export function Nav() {
  ...
  return (
    <>
        ...
        >
          ...
          <div className="flex items-center gap-2 md:hidden">
            ...
            <button
              ...
              className="relative grid h-11 w-11 place-items-center rounded-full bg-cream/90 text-ink shadow-soft active:scale-95"
            >
      ...
      {/* Mobile overlay — rendered OUTSIDE the sticky header to avoid
          stacking-context and iOS-Safari sticky-ancestor bugs. */}
      <AnimatePresence>
        {open && (
          <motion.div
            key="mobile-overlay"
          ...
          >
            ...
            <motion.div
              ...
              className="relative mx-3 mt-3 overflow-hidden rounded-3xl bg-cream shadow-ring"
            >
              <div className="flex items-center justify-between border-b border-ink/6 px-4 py-3">
                <Link
                  ...
                  aria-label="Glaces en Seine — accueil"
                >
                  <div className="relative h-9 w-9 shrink-0">
                    <Image src="/logo-transparent.png" alt="" fill sizes="36px" className="object-contain" />
                  </div>
                  <div className="leading-tight">
                    <div className="font-display text-[15px] text-ink">Glaces en Seine</div>
                    <div className="-mt-0.5 font-script text-[12px] text-teal-700">La Frette-sur-Seine</div>
                  </div>
                </Link>
                <button
                  type="button"
                  ...
                  aria-label="Fermer le menu"
                  style={{ touchAction: "manipulation", WebkitTapHighlightColor: "transparent" }}
                  className="grid h-10 w-10 place-items-center rounded-full bg-ink/5 text-ink active:scale-95"
                >
                  <X className="h-5 w-5" />
                </button>
              </div>
