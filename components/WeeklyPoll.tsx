...
const QUESTIONS: Question[] = [
  ...
  {
    text: "Meilleur moment pour croquer une gaufre ?",
  ...
  {
    text: "Après une promenade sur le quai, qu'est-ce qui manque ?",
  ...
  },
  {
    ...
    choices: [
      { key: "cat",   emoji: "🐱", label: "Chat — douce et câline (vanille)",     bar: "bg-sun-400" },
      { key: "bear",  emoji: "🐻", label: "Ours — intense (chocolat noir)",        bar: "bg-stone-500" },
      { key: "fox",   emoji: "🦊", label: "Renard — malin (caramel salé)",         bar: "bg-orange-400" },
      { key: "bee",   emoji: "🐝", label: "Abeille — piqûre (sorbet citron)",      bar: "bg-yellow-400" },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { key: "tournesoleil",emoji:"🌻", label: "Les Bronzés font du ski",bar: "bg-sun-400" },
    ],
  },
];
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-[10.5px] font-bold uppercase tracking-[0.2em] text-sun-300">
                  Sondage du quai · semaine {getWeekNumber()}
                </p>
                    ...
                    <div className="relative flex items-center justify-between gap-2">
                      ...
                      {vote && ready && (
                        <motion.span
                          initial={{ opacity: 0 }}
                          animate={{ opacity: 1 }}
                          className="text-[12.5px] font-bold text-cream/70"
                        >
                          {pv} %
                        </motion.span>
                      )}
